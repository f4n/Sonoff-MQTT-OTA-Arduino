/*
 ...
 by hexenmeister @ https://github.com/hexenmeister/AS_BH1750
...
AS_BH1750 bh1750;                         // BH1750 lux sensor
bool bh1750_detected = false;

boolean bh1750_detect()
{
  if (bh1750_detected) return true;

  if(bh1750.begin(RESOLUTION_AUTO_HIGH, false)) {
...
uint8_t bh1750_found()
{
  return bh1750_detected;
}
