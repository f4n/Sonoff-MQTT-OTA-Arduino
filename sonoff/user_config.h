...
#define MQTT_CLIENT_ID         "sonoff-{mac}"  // [MqttClient] Also fall back topic using Chip Id = last 6 characters of MAC address
...
#define MQTT_TOPIC             "sonoff-{mac}" // [Topic] (unique) MQTT device topic
