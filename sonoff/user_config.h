...
#define WIFI_HOSTNAME          "sonoff-{mac}"         // [Hostname] Expands to <MQTT_TOPIC>-<last 4 decimal chars of MAC address>
#define WIFI_CONFIG_TOOL       WIFI_MANAGER    // [WifiConfig] Default tool if wifi fails to connect (WIFI_SMARTCONFIG, WIFI_MANAGER or WIFI_WPSCONFIG)
...
#define MQTT_CLIENT_ID         "DVES_{mac}"  // [MqttClient] Also fall back topic using Chip Id = last 6 characters of MAC address
...
//  #define SEND_TELEMETRY_DS18x20  1          // Enable sending multi temperature telemetry
/*-------------------------------------------------------------------------------------------*\
